...
exports.remove_alert = exports.show_alert = void 0;
...
var remove_alert = function remove_alert() {
  setTimeout(function () {
    var el = document.querySelector('.alert-custom');
...
exports.login = login;
},{"./alert":"alert.js"}],"addnote.js":[function(require,module,exports) {
"use strict";
...
var add_note = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(title, text) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
},{}],"sign.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            if (_context.t0.response) {
              (0, _alert.show_alert)(_context.t0.response.data.error, 'sign');
              (0, _alert.remove_alert)();
            }
...
},{"./alert":"alert.js"}],"delete.js":[function(require,module,exports) {
"use strict";
...
var delete_note = /*#__PURE__*/function () {
...
exports.update_note = void 0;

function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }

var update_note = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(title, text, id) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
},{"base64-js":"../../node_modules/base64-js/index.js","ieee754":"../../node_modules/ieee754/index.js","isarray":"../../node_modules/isarray/index.js","buffer":"../../node_modules/buffer/index.js"}],"get_user.js":[function(require,module,exports) {
...
var get_user = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(user, note) {
    var res, source, html, _html;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "Success") {
              ...
              if (res.data.user.photo) source = "data:".concat(res.data.user.photo.contentType, ";base64,").concat(new Buffer.from(res.data.user.photo.data).toString('base64'));
              html = "\n      <div class=\"user_box\" data-to= ".concat(res.data.user._id, " data-note=").concat(note, ">\n      \n      <h1> <img src= ").concat(source, "> ").concat(res.data.user.name, "</h1>\n      </div>\n      ");
          ...
          case 7:
            ...
            if (_context.t0.response) {
              if (_context.t0.response.data.error === 'User not found') {
                _html = "\n        <div class=\"not-found\">\n         <h>User not found<h>\n        </div>\n        ";
                document.querySelector('.search_res').innerHTML = '';
                document.querySelector('.search_res').insertAdjacentHTML('afterbegin', _html);
              }
            }
...
},{"buffer":"../../node_modules/buffer/index.js"}],"share.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.share_note = void 0;
...
var remove = function remove() {
  setTimeout(function () {
    var el = document.querySelector('.msg_box');
    if (el) el.parentElement.removeChild(el);
  }, 5000);
};

var share_note = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(user, note) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios({
              method: 'GET',
              url: "/api/v1/notes/sharenote/".concat(JSON.parse(note), "/user/").concat(JSON.parse(user))
            });
          ...
          case 7:
            ...
            if (_context.t0.response) {
              if (_context.t0.response.data.error === 'Already sent note to this user') {
                msg_box(_context.t0.response.data.error);
                remove();
              }
...
},{}],"share_del.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.del_rece = exports.del_sent = void 0;

function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }

var del_sent = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios({
              method: 'DELETE',
              url: "/api/v1/notes/sent/delete/".concat(id)
            });
  ...
  return function del_sent(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.del_sent = del_sent;

var del_rece = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return axios({
              method: 'DELETE',
              url: "/api/v1/notes/receive/delete/".concat(id)
            });
          ...
          case 7:
            ...
            if (_context2.t0.response) console.log(_context2.t0.response.data);
  ...
  return function del_rece(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.del_rece = del_rece;
},{}],"user_upd.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.update_me = void 0;

function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }

var update_me = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? '/api/v1/user/update_password' : '/api/v1/user/update_me';
            _context.next = 4;
            return axios({
              method: 'PATCH',
              url: url,
...
var _share_del = require("./share_del");

var _user_upd = require("./user_upd");
...
var sign_form = document.querySelector('#form-sign');
var save_btn = document.querySelector('.create_form');
var del_btn = document.querySelectorAll('.delete');
var upd_btn = document.querySelectorAll('.update_form');
var upd_inp = document.querySelectorAll('.update_inp');
var upd_txt = document.querySelectorAll('.update_txt');
var search_form = document.querySelector('#search_form');
var share = document.querySelector('.search_res');
var sent_del = document.querySelectorAll('.sent_del');
var receiv_del = document.querySelectorAll('.receiv_del');
var user_form = document.querySelector('#form_user');
var pass_form = document.querySelector('#form_password');

var set_field = function set_field() {
  if (upd_inp && upd_txt) {
    upd_inp.forEach(function (el) {
      el.value = el.dataset.title;
    });
    upd_txt.forEach(function (el) {
      el.value = el.dataset.text;
    });
  }
};

var add_spinner = function add_spinner(element, txt) {
  element.textContent = " ";
  element.disabled = true;
  var html = "<span class=\"spinner-grow spinner-grow-sm\"></span> ".concat(txt, "...");
  element.insertAdjacentHTML('afterbegin', html);
};

var remove_spinner = function remove_spinner(element, txt) {
  element.disabled = false;
  element.textContent = "".concat(txt);
};

if (login_form) {
  login_form.addEventListener('submit', /*#__PURE__*/function () {
...
if (sign_form) {
  sign_form.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
      var name, email, password, confirmPassword, sign_btn;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return _context3.abrupt("return", document.querySelector('#msg4').innerHTML = 'Password is not same');

            case 7:
              document.querySelector('#msg4').innerHTML = ""; // console.log(name,email,password,confirmPassword);

              sign_btn = document.querySelector("#sign_in");
              add_spinner(sign_btn, 'Loading');
              _context3.next = 12;
              return (0, _sign.sign_in)(name, email, password, confirmPassword);
...
if (del_btn) {
  del_btn.forEach(function (el) {
    el.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
      var note;
...
if (search_form) {
  search_form.addEventListener('submit', /*#__PURE__*/function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(e) {
      var btn, note, user, user_name;
...
if (share) {
  share.addEventListener('click', /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(e) {
      var el, user, note, elem;
...
if (sent_del) {
  sent_del.forEach(function (el) {
    el.addEventListener('click', function () {
      var note = el.dataset.share;
      (0, _share_del.del_sent)(note);
    });
  });
}

if (receiv_del) {
  receiv_del.forEach(function (el) {
    el.addEventListener('click', function () {
      var note = el.dataset.share;
      (0, _share_del.del_rece)(note);
    });
  });
}
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              ...
              elem = document.querySelector('.save_setting');
              add_spinner(elem, 'Saving');
              _context8.next = 9;
              return (0, _user_upd.update_me)(form, 'setting');
...
if (pass_form) {
  pass_form.addEventListener('submit', /*#__PURE__*/function () {
    var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(e) {
      var Currentpassword, newpassword, confirmNewPassword, form, elem;
      return regeneratorRuntime.wrap(function _callee9$(_context9) {
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              e.preventDefault();
              Currentpassword = document.querySelector('#curr_pass').value;
              newpassword = document.querySelector('#new_pass').value;
              confirmNewPassword = document.querySelector('#conf_new_pass').value;
              form = {
              ...
              return _context9.abrupt("return", document.querySelector('#pass_conf').innerHTML = 'Password is not same');

            case 7:
              document.querySelector('#pass_conf').innerHTML = "";
              elem = document.querySelector('#chng_pass');
              add_spinner(elem, 'Updating');
              _context9.next = 12;
              return (0, _user_upd.update_me)(form, 'password');
