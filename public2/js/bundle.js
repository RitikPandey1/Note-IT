...
},{}],"get_user.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "Success") {
              html = "\n      <div class=\"user_box\" data-to= ".concat(res.data.user._id, " data-note=").concat(note, ">\n      \n      <h1> <img src=\"/user_pic/").concat(res.data.user.photo, "\"> ").concat(res.data.user.name, "</h1>\n      </div>\n      ");
...
},{}],"share.js":[function(require,module,exports) {
"use strict";
